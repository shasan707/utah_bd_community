    ...
    fields: [
      {
        ...
        type: "text",
        help: "Pre-filled with the same value as the first version. Change it only if the alias enrolled in Zelle at the bank changes.",
      },
      {
      ...
      },
      {
        ...
        type: "email",
        help: "Pre-filled. Replies from members and short-amount alerts go here.",
      },
    ],
  },
];
